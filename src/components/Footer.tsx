      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 flex items-center justify-center rounded-full bg-white border border-gray-200 text-muted-foreground hover:text-blockchain-500 transition-colors">
            ...
            <div key={index}>
              ...
              <ul className="space-y-3">
                {section.links.map((link, linkIndex) => (
                  <li key={linkIndex}>
                    <Link to={link.href} className="text-muted-foreground hover:text-blockchain-500 transition-colors">
                      {link.label}
                    </Link>
                  </li>
                ))}
        ...
        <div className="mt-12 pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-6 text-sm text-muted-foreground">
            <Link to="/privacy" className="hover:text-blockchain-500 transition-colors">Privacy</Link>
            <Link to="/terms" className="hover:text-blockchain-500 transition-colors">Terms</Link>
            <Link to="/cookies" className="hover:text-blockchain-500 transition-colors">Cookies</Link>
          </div>
        </div>
      </div>
    </footer>
